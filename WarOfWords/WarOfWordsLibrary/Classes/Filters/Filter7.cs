...
{
    public class Filter7 : BaseFilter, IFilter
    {
        public string Rank
        {
            get
        ...
        public int GetFilterElements(string keyWord)
        {
            ...
            for (int i = 1; i <= keyWord.Length; i++)
            {
                ...
                for (int j = 0; j <= partsNumber; j++)
                {
                    ...
                    filterElement.Filter = "LENGTH(WORD) = " + keyWord.Length + " AND WORD <> '" + keyWord + "' AND (" + filterElement.Filter + ")";
        ...
        public string FillWordWithWildcard(int[] map, string word)
        {
            ...
            for (int i = 0; i < map.Length; i++)
            {
                ...
                wordFilled = wordFilled.Insert(map[i] - 1, "_");
            }
            return wordFilled;
        }
    }
